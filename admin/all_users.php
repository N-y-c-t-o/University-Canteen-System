                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-header">
                            <h2 class="m-b-0 text-white">Users' Details</h2>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $imgPath = 'upload/' . htmlspecialchars($row['profile']);
                                            echo "<tr class='clickable-row' data-href='editProfile.php?id=" . htmlspecialchars($row['u_id'], ENT_QUOTES, 'UTF-8') . "'>";
                                            echo "<td>" . htmlspecialchars($row['u_id'], ENT_QUOTES, 'UTF-8') . "</td>"; // Display user ID
                                            echo "<td>";
