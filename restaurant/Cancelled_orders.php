...
$query = "SELECT * FROM cancelled_orders WHERE rs_id=$rs_id ORDER BY id DESC";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            if ($currentOrderNum !== $row['orderNum']) {
                                                ...
                                                $sql_count = "SELECT COUNT(*) as count FROM cancelled_orders WHERE orderNum = '$currentOrderNum'";
                                                ...
                                                echo "<td rowspan='{$rowCount}' class='text-center'>" . htmlspecialchars($row['cancelled_time'], ENT_QUOTES, 'UTF-8') . "</td>";
                                                echo "</tr>";
                                            } else {
