...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['delete'])) {
        ...
        $stmt = $conn->prepare("DELETE FROM users_orders WHERE d_id = ?");
        $stmt->bind_param("i", $d_id);
        $stmt->execute();
        $stmt->close();
            ...
            <ul id="sidebarnav">
                ...
                <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-shopping-cart f-s-20 color-warning"></i><span class="hide-menu">Orders</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="Cancelled_orders.php"><i class="fa fa-truck"></i><span>Cancelled Orders</span></a></li>
                        <li><a href="Delivered_orders.php"><i class="fa fa-truck"></i><span>Delivered Orders</span></a></li>
                    </ul>
                </li>
