    ...
    <section class="about-us">
        <div class="container">
            ...
            <div class="about-images">
                <img src="photos/meat.png" alt="Team Image 1">
                <img src="photos/tealeaf.png" alt="Team Image 2">
                <img src="photos/glass.png" alt="Team Image 3">
            </div>
            ...
            <div class="content-section">
                <div class="left-content">
                    <img src="photos/chan.jpg" alt="Canteen Manager">
            ...
            <div class="content-section2">
                ...
                <div class="features">
                    ...
                    <div class="feature-box">
                        ...
                        <p>We’re open from early morning until late evening, ensuring you can grab a meal whenever you need it.</p>
                    </div>
                    <div class="feature-box">
                        <div class="icon">💳</div>
                        <h3>Student Discounts</h3>
                        <p>Enjoy special discounts and deals exclusively for students to help you save on your favorite meals.</p>
                    </div>
                </div>
            </div>
        </div>
